document.addEventListener('DOMContentLoaded', function() {
    ...
    // Images container
    var images = document.getElementById('carousel3Images');
    
    // Image caption
    var caption = document.getElementById('carousel3Caption');
    
    // Previous image button
    var prev = document.getElementById('carousel3Prev');
    
    // Next image button
    var next = document.getElementById('carousel3Next');
    
    
    /* ------------------------------
      Fetch our gallery JSON object
    ------------------------------ */
    fetch("js/assets/gallery6.json")
