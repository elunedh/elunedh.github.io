document.addEventListener('DOMContentLoaded', function() {
    ...
    // Images container
    var images = document.getElementById('carousel2Images');
    
    // Image caption
    var caption = document.getElementById('carousel2Caption');
    
    // Previous image button
    var prev = document.getElementById('carousel2Prev');
    
    // Next image button
    var next = document.getElementById('carousel2Next');
    
    
    /* ------------------------------
      Fetch our gallery JSON object
    ------------------------------ */
    fetch("js/assets/gallery4.json")
